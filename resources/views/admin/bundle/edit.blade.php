                    ...
                    <form action="{{ route('admin.bundle.store') }}" method="PUT"
                        ...
                        <div class="card-body px-lg-2 pt-0">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-12 col-sm-12 pricing-details">
                                    <div class="text-left pl-3 pt-3">
                                        <table class="table table-bordered">
                                            <tr class="bundle-item-cost">
                                                <td style="width:120px;">
                                                    <p class="text-sm mb-0"><b class="d-block info-lb">Total Cost :</b></p>
                                                </td>
                                                <td style="text-align: right">
                                                    <p class="text-sm mb-0"><b class="d-block info-lb"><span id="total-cost-lbl">{{ number_format($data->total_cost, 2) }}</span></b></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width:120px;">
                                                    <p class="text-sm mb-0"><b class="d-block info-lb">Total Retail :</b></p>
                                                </td>
                                                <td style="text-align: right">
                                                    <p class="text-sm mb-0"><b class="d-block info-lb"><span id="retail-lbl">{{ number_format($data->total_retail, 2) }}</span></b></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width:120px;">
                                                    <p class="text-sm mb-0"><b class="d-block info-lb">Difference :</b></p>
                                                </td>
                                                <td style="text-align: right">
                                                    <p class="text-sm mb-0"><b class="d-block info-lb"><span id="diff-lbl">{{ number_format($data->bundle_cost - $data->total_cost, 2) }}</span></b></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width:120px;">
                                                    <p class="text-sm mb-0"><b class="d-block info-lb">Bundle Cost :</b></p>
                                                </td>
                                                <td style="text-align: right">
                                                    <p class="text-sm mb-0"><b class="d-block info-lb"><span id="bundle-cost-lbl">{{ number_format($data->bundle_cost, 2) }}</span></b></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                        ...
                                        @foreach ($bundleItems as $value)
                                            <tr class="row_position" data-id="{{ $i }}" id="{{ $value['id'] }}">
                                                ...
                                                <td class="item-list-display-report">
                                                    <input type="checkbox" id="item" name="item" onclick="updateDisplayStatus(this)" value="{{ $value['id'] }}" class="form-check-label" @if($value['display_report'] == 1) checked @endif>
                                                </td>
                                                <td>
                        ...
                        <br>
                        <div class="col-lg-2 col-md-3 col-sm-6 mx-auto"  style="float:left;">
