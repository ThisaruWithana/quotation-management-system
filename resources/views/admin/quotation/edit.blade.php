                        ...
                        <div class="card-body px-lg-2 pt-0">
                            <div>
                                <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group text-left">
                                                        ...
                                                        <select id="customer" name="customer" class="selectpicker show-tick form-control" data-live-search="true" @if($data->status != 1) disabled @endif>
                                                            <option value="">Select Client</option>
                                                            @foreach ($customers as $value)
                                                                <option value="{{ $value->id }}" {{ $value->id === $data->customer_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="row">
                                            <div class="col-12 customer-details" style="display:block;margin-top: 0px;">
                                                <div class="text-left">
                            ...
                            <div class="add-items" style="display:block;">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group text-left">
                                            ...
                                            <select id="bundle" name="bundle" class="selectpicker show-tick form-control" data-live-search="true" @if($data->status != 1) disabled @endif>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12" id="retail-print-option" style="display:none;">
                                        <div class="form-group text-left">
                                            <label for="retail_print_option" class="form-label">Print retails prices in print </label>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="checkbox" id="retail_print_option" name="retail_print_option" value="1" class="form-check-label" @if($data['retail_print_option'] == 1)  checked @endif>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="col-lg-2 col-md-4 mt-3 mb-3 p-0 float-right">
