                    ...
                    <form action="{{ route('admin.stock.adjustment') }}" method="POST"
                        ...
                        <div class="card-body px-lg-2 pt-0">
                            ...
                            <div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group text-left">
                                                            ...
                                                            <input type="date" class="form-control datepicker" id="date" name="date" value="{{ date('Y-m-d') }}" readonly>
                                                ...
                                                <div class="text-left" style="margin-left:100px;margin-top: 25px;">
                                                    <table class="table table-bordered ">
                                                        <tr>
                                                            ...
                                                            <td style="width:100px;"><p class="text-sm mb-0 text-bold"><span id="total-cost-lbl"></span></p></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:100px;"><p class="text-sm mb-0 text-bold">Total Retail :</p></td>
                                                            <td style="width:100px;"><p class="text-sm mb-0 text-bold"><span id="total-retail-lbl"></span></p></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:100px;"><p class="text-sm mb-0 text-bold">Total Cost Difference :</p></td>
                                                            <td style="width:100px;"><p class="text-sm mb-0 text-bold"><span id="total-cost-diff-lbl"></span></p></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width:100px;"><p class="text-sm mb-0 text-bold">Total Retail Difference :</p></td>
                                                            <td style="width:100px;"><p class="text-sm mb-0 text-bold"><span id="total-retail-diff-lbl"></span></p></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </div>
                                ...
                                <input type="hidden" name="stock_take_id" id="stock_take_id" value="">
                            </div>
